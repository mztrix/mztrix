...
A Symfony-based starter project for building robust REST APIs:
* Includes **API Platform**, **JWT authentication**.
* Pre-configured with **Docker** for immediate productivity.
